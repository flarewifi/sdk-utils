...
go run -tags="dev" ./core/utils/translator --validate

# Get untranslated entries (AI-friendly)
go run -tags="dev" ./core/utils/translator --untranslated-report --compact
```
...
3. Run tool to sync: `go run -tags="dev" ./core/utils/translator`
...
1. Add translation in code: `api.Translate("label", "Dashboard")`
2. Run tool with flag: `go run -tags="dev" ./core/utils/translator --create-missing`
...
go run -tags="dev" ./core/utils/translator --create-missing

# Preview what --create-missing would do (dry-run)
go run -tags="dev" ./core/utils/translator --create-missing --dry-run

# Validation (read-only)
go run -tags="dev" ./core/utils/translator --validate

# Summary (overview)
go run -tags="dev" ./core/utils/translator --summary --compact

# Untranslated entries (AI-friendly)
go run -tags="dev" ./core/utils/translator --untranslated-report --compact

# Filter by language
go run -tags="dev" ./core/utils/translator --untranslated-report --language es --compact

# Filter by component
go run -tags="dev" ./core/utils/translator --untranslated-report --component core --compact

# Pagination (large datasets)
go run -tags="dev" ./core/utils/translator --untranslated-report --limit 20 --offset 0 --compact

# Markdown report
go run -tags="dev" ./core/utils/translator --markdown-report report.md
```
...
```bash
# Get summary
go run -tags="dev" ./core/utils/translator --untranslated-report --language es --summary --compact

# Get batches
go run -tags="dev" ./core/utils/translator --untranslated-report --language es --limit 50 --compact
go run -tags="dev" ./core/utils/translator --untranslated-report --language es --offset 50 --limit 50 --compact
```

**Process by component:**
```bash
go run -tags="dev" ./core/utils/translator --untranslated-report --component core --compact
go run -tags="dev" ./core/utils/translator --untranslated-report --component paystack --compact
```

**Parallel processing (multiple AI agents):**
```bash
# Agent 1: Spanish core
go run -tags="dev" ./core/utils/translator --untranslated-report --language es --component core --compact

# Agent 2: French core
go run -tags="dev" ./core/utils/translator --untranslated-report --language fr --component core --compact
```
