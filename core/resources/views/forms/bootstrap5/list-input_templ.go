	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if lf.Multiple {
			...
			if lf.OptionType == sdkapi.OptionTypeSelect {
				optType = sdkapi.OptionTypeSelect
			}
		}
		...
		if optType == sdkapi.OptionTypeSelect {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `resources/views/forms/bootstrap5/list-input.templ`, Line: 53, Col: 70}
			}
			...
			for i, opt := range lf.Options() {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `resources/views/forms/bootstrap5/list-input.templ`, Line: 57, Col: 44}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `resources/views/forms/bootstrap5/list-input.templ`, Line: 59, Col: 18}
				}
			...
			for i, opt := range lf.Options() {
				...
				templ_7745c5c3_Var12, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprint(optType))
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `resources/views/forms/bootstrap5/list-input.templ`, Line: 68, Col: 32}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `resources/views/forms/bootstrap5/list-input.templ`, Line: 69, Col: 61}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `resources/views/forms/bootstrap5/list-input.templ`, Line: 70, Col: 43}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `resources/views/forms/bootstrap5/list-input.templ`, Line: 75, Col: 17}
				}
		...
		if cfg.error != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `resources/views/forms/bootstrap5/list-input.templ`, Line: 82, Col: 55}
			}
