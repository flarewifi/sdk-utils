(function () {
  ...
  function mayProcessLoadingStateByPath(elt, requestPath) {
    var pathElt = htmx.closest(elt, '[data-loading-path]');
    if (!pathElt) {
      return true;
    }
  ...
  function queueLoadingState(sourceElt, targetElt, doCallback, undoCallback) {
    var delayElt = htmx.closest(sourceElt, '[data-loading-delay]');
    if (delayElt) {
  ...
  htmx.defineExtension('loading-states', {
    onEvent: function (name, evt) {
      if (name === 'htmx:beforeRequest') {
        var container = loadingStateContainer(evt.target);

        var loadingStateTypes = [
          'data-loading',
          'data-loading-class',
