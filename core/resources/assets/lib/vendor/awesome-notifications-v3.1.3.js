...
!function (t, e) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) ? module.exports = e() : "function" == typeof define && define.amd ? define([], e) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? exports.AWN = e() : t.AWN = e();
}(self, function () {
  return function () {
    "use strict";
    ...
    var i = {
      ...
      a = function () {
        ...
        return e = t, a = [{
          ...
          value: function value(t, e) {
            var o = {};
            for (var r in t) e.hasOwnProperty(r) ? o[r] = "object" === n(t[r]) && null !== t[r] ? this.defaultsDeep(t[r], e[r]) : e[r] : o[r] = t[r];
            return o;
          }
        }], a && r(e.prototype, a), t;
      }(),
      ...
      return e = t, n = [{
        ...
        value: function value() {
          ...
          return this.start && (n = this.options.minDurations[this.type] + this.start - Date.now()) < 0 && (n = 0), new Promise(function (o) {
            setTimeout(function () {
              e.classList.add(f.klass.hiding), setTimeout(o, t.options.animationDuration);
            }, n);
          });
        }
      }, {
    ...
    var w = function (t) {
      ...
      function a(t, e, n, o) {
        ...
        return function (t, e) {
          if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
        }(this, a), (r = i.call(this, o, "".concat(u.prefix, "-").concat(Math.floor(Date.now() - 100 * Math.random())), "".concat(u.prefix, " ").concat(u.prefix, "-").concat(e), "animation-duration: ".concat(n.toSecs(n.animationDuration), ";"), n)).updateType(e), r.setInnerHtml(t), r;
      }
      return e = a, n = [{
        key: "setInnerHtml",
        value: function value(t) {
          "alert" === this.type && t && (t = this.options.formatError(t)), t = this.options.applyReplacements(t, this.type), this.newNode.innerHTML = '<div class="awn-toast-wrapper">'.concat(this.progressBar).concat(this.label, '<div class="').concat(u.klass.content, '">').concat(t, '</div><span class="').concat(u.klass.icon, '">').concat(this.options.icon(this.type), "</span></div>");
        }
      }, {
        key: "beforeInsert",
        value: function value() {
          ...
          if (this.parent.childElementCount >= this.options.maxNotifications) {
            var e = Array.from(this.parent.getElementsByClassName(u.prefix));
          ...
          if (this.addEvent("click", function () {
            ...
            for (var e = 0, n = ["mouseenter", "mouseleave"]; e < n.length; e++) {
              ...
              this.addEvent(o, function () {
                t.isDeleted() || (t.toggleClass(u.klass.progressBarPause), t.timer.toggle());
              });
            }
          }
        }
        ...
        key: "progressBar",
        get: function get() {
          return this.duration <= 0 || "async" === this.type ? "" : "<div class='".concat(u.klass.progressBar, "' style=\"animation-duration:").concat(this.options.toSecs(this.duration), ';"></div>');
        }
      }, {
        key: "label",
        get: function get() {
          return '<b class="'.concat(u.klass.label, '">').concat(this.options.label(this.type), "</b>");
        }
      }], n && v(e.prototype, n), a;
    }(d);
    function O(t) {
    ...
    var P = function (t) {
      ...
      function a(t) {
        ...
        return (e = i.call(this, document.body, l.ids.wrapper, null, s, o))[l.ids.confirmOk] = r, e[l.ids.confirmCancel] = c, e.className = "".concat(l.prefix, "-").concat(n), ["confirm", "async-block", "modal"].includes(n) || (n = "modal"), e.updateType(n), e.setInnerHtml(t), e.insert(), e;
      }
      return e = a, (n = [{
        key: "setInnerHtml",
        value: function value(t) {
        ...
        value: function value(t) {
          ...
          switch (t.code) {
            ...
            case "Tab":
              if (t.preventDefault(), "confirm" !== this.type || !1 === this[l.ids.confirmCancel]) return !0;
              var e = this.okBtn;
              t.shiftKey ? document.activeElement.id == l.ids.confirmOk && (e = this.cancelBtn) : document.activeElement.id !== l.ids.confirmCancel && (e = this.cancelBtn), e.focus();
          }
        }
      }, {
        key: "afterInsert",
    ...
    var B = function () {
      ...
      return e = t, (n = [{
        ...
        key: "async",
        value: function value(t, e, n, o, r) {
        ...
        value: function value() {
          return new d(document.body, u.ids.container, "awn-".concat(this.options.position)).insert().el;
        }
      }, {
        key: "container",
        get: function get() {
          return document.getElementById(u.ids.container) || this._createContainer();
        }
      }]) && x(e.prototype, n), t;
    }();
    return e;
