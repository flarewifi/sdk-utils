...
SYNC_VERSION="./core/tools/cmd/sync-versions/main.go"
BUILD_ASSETS_MAIN="./core/tools/cmd/build-assets/main.go"
MONO_BIN_PREPARE="./core/tools/cmd/mono-bin-prepare/main.go"
MONO_BIN_COMPILE="./core/tools/cmd/mono-bin-compile/main.go"
MONO_BIN_COPY_OUTPUT="./core/tools/cmd/mono-bin-copy-output/main.go"
MONO_BIN_OUTDIR=".tmp/mono-bin"
FLARE_CLI_MAIN="./core/internal/cli/main.go"
PATH="$PATH:$HOME/go/bin"

./scripts/install-tools.sh && \
    ./scripts/opkg-install.sh && \
