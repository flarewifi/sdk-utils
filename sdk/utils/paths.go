...
var (
	...
	PathSharedDir         = filepath.Join(PathAppDir, "shared")
	PathConfigDir         = filepath.Join(PathSharedDir, "config")
	PathConfigDefaultsDir = filepath.Join(PathConfigDir, ".defaults")
	...
	PathPluginLocalDir    = filepath.Join(PathSharedDir, "plugins", "local")
	PathPluginSystemDir   = filepath.Join(PathSharedDir, "plugins", "system")
